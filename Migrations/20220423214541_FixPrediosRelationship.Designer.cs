...
namespace Asping.Migrations
{
    ...
    [Migration("20220423214541_FixPrediosRelationship")]
    partial class FixPrediosRelationship
    {
            ...
            modelBuilder.Entity("asping.Model.Quote", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AuthorId = 2,
                            CreatedAt = new DateTime(2022, 4, 23, 22, 45, 41, 400, DateTimeKind.Local).AddTicks(2966),
